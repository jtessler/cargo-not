...
cn.leveldata.levels = {
  ...
  'Re-Curses': [
    ...
    [[],
      ['yellow', 'yellow', 'yellow', 'yellow']],
    'Move one crate to the right, go back to the original position, and then ' +
  ...
  'Double Flip': [
    ...
    [12, 6, 5],
    [8, 8, 8, 5],
    ['right', 'pickup', 'left', 'f1', 'f2', 'f3', 'f4', 'blue', 'red', 'green',
      'yellow', 'none', 'multi'],
    [['blue', 'red', 'green', 'yellow'], [], []],
    [[], [], ['blue', 'red', 'green', 'yellow']],
  ...
  'Go the Distance': [
    ...
    [12, 6, 4],
    [8, 8, 8, 5],
    ['right', 'pickup', 'left', 'f1', 'f2', 'f3', 'f4', 'red', 'yellow', 'none',
      'multi'],
  ...
  'Color Sort': [
    ...
    [14, 10, 8],
    [8, 8, 8, 5],
    ['right', 'pickup', 'left', 'f1', 'f2', 'f3', 'f4', 'red', 'green', 'none',
      'multi'],
    [[], ['green', 'green', 'red', 'green', 'red', 'red'], []],
    [['red', 'red', 'red'], [], ['green', 'green', 'green']],
    'Go over each of the 3 piles and drop or pick up based on the color. ' +
        'When over the left pile drop if red, when over the right pile drop ' +
  ...
  'Walking Piles': [
    ...
    'For a 3 star solution, move each pile 3 slots to the right, and then ' +
        ...
        'shortest known solution uses 9 registers (with an approach that is ' +
        'very specific to this configuration)'
  ],
  'Repeat Inverter': [
    1,
    [9, 7, 5],
  ...
  'Mirror': [
    ...
    [[], ['green', 'green'], ['green'], ['green'], ['green', 'green'],
      ['yellow', 'yellow', 'yellow', 'yellow']],
    'Use at most 7 registers for 3 stars. There are various known solutions ' +
        'with 6 registers in F1, but no known solution with only 5.'
  ],
  'Lay it out': [
    1,
    [13, 9, 7],
  ...
  'Come Together': [
    ...
    [['yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow'], [], [], [],
      [], [], []],
    'You can go right and find a yellow crate, but when bringing it back how ' +
        'do you know when to stop so that you don\'t crash into the wall?' +
        '\n\nIn F2 use the programming stack to count the number of times ' +
        'you have to go right until you find a yellow crate, then go ' +
        'back left that same number of times. Another way to look at it: F2 ' +
        'is a recursive function that goes right until it finds a crate, and ' +
        'then it goes back to the original position. It can be implemented ' +
        'with 4 registers.\n\nThe shortest known solution uses a total of 7 ' +
        'registers.'
  ],
  'Come Together 2': [
    1,
  ...
  'Up The Greens': [
    ...
    [12, 9, 7],
    [8, 8, 8, 5],
    ['right', 'pickup', 'left', 'f1', 'f2', 'f3', 'f4', 'blue', 'green', 'none',
      'multi'],
  ...
  'Count The Blues': [
    ...
    'Another stack puzzle. The number of blues indicates how many times ' +
        'to go right with the yellow.\n\nThe shortest known solution uses 9 ' +
        'registers.'
  ],
  'Multi Sort': [
    1,
    ...
    'Come Together for yellows, The Stacker for blues. Go forward until you ' +
        'find a crate. If blue, move it one slot further and come all ' +
        'the way back (using the stack) empty handed. If yellow, bring ' +
        'it back and drop it. Repeat.\n\nThe shortest known solution uses 11 ' +
        'registers.'
  ],
  'Divide by two': [
    1,
  ...
  'Palette Swap': [
    ...
    'Go left and go right. Each time you do so, wind up the stack. When no ' +
        'more crates are left, unwind the stack going left and going right. ' +
  ...
  'Mirror 2': [
    ...
    [['yellow', 'yellow', 'yellow'], ['yellow', 'yellow'], ['yellow'], []],
    [[], ['yellow'], ['yellow', 'yellow'], ['yellow', 'yellow', 'yellow']],
    'Move the top crate of the 2nd pile one slot to the right, and bring the ' +
        'left pile all the way to the right.\n\nThe shortest known ' +
